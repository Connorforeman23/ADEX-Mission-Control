-- ADEX Randox import - part 3 of 6
...
select * from (
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-04-06', date '2026-04-19', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-04-06', date '2026-04-19', 'New Copy', 2615, 0, 2615
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-05-04', date '2026-05-17', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-05-04', date '2026-05-17', 'New Copy', 1979, 0, 1979
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-05-04', date '2026-05-17', 'New Copy', 406, 0, 406
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-05-04', date '2026-05-17', 'New Copy', 652, 0, 652
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-05-04', date '2026-05-17', 'New Copy', 4878, 0, 4878
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-06-01', date '2026-06-14', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-06-01', date '2026-06-14', 'New Copy', 2615, 0, 2615
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-07-13', date '2026-07-26', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-07-13', date '2026-07-26', 'New Copy', 1979, 0, 1979
