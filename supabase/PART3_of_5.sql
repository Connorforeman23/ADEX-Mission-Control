-- ADEX Randox import - part 3 of 5
...
select * from (
  select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', null, null, 'New Copy', 406, 0, 406
