-- ADEX Randox import - part 5 of 6
...
select * from (
  ...
  union all select (select id from campaigns where ref='AE-2582'), 'RAN0083', 'Lee Capon', 'production', 'OOH', 'JCD', 'Production', date '2026-07-27', date '2026-08-23', 'New Copy', 400, 0, 400
  ...
  union all select (select id from campaigns where ref='AE-2584'), 'RAN0085', 'Lee Capon', 'production', 'OOH', 'JCD', 'Production', date '2026-04-06', date '2026-11-02', 'New Copy', 325, 0, 325
  union all select (select id from campaigns where ref='AE-2584'), 'RAN0085', 'Lee Capon', 'production', 'OOH', 'JCD', 'Production', date '2026-04-06', date '2026-11-02', 'New Copy', 325, 0, 325
  ...
  union all select (select id from campaigns where ref='AE-2589'), 'RAN0090', 'Karima Dernawi', 'media', 'OOH', 'Global OOH', 'Global', date '2026-05-14', date '2026-05-14', 'New Copy', 4202.4, 15, 4202.4
) v;

-- booking lines 126-150 of 157
insert into campaign_lines (campaign_id, supplier_po, supplier_contact, line_type, channel, vendor, detail, start_date, end_date, copy_instruction, supplier_gross, commission_pct, client_charge)
select * from (
  select (select id from campaigns where ref='AE-2589'), 'RAN0090', 'Karima Dernawi', 'production', 'OOH', 'Global OOH', 'Production on x1 48 Sheet', date '2026-05-14', date '2026-05-14', 'New Copy', 258, 0, 258
  ...
  union all select (select id from campaigns where ref='AE-2590'), 'RAN0091', 'Karima Dernawi', 'production', 'OOH', 'Global OOH', 'Production on x1 48 Sheet', date '2026-07-13', date '2026-08-23', 'New Copy', 258, 0, 258
  ...
  union all select (select id from campaigns where ref='AE-2592'), 'RAN0094', 'Lee Capon', 'production', 'OOH', 'JCD', 'Production x 2', date '2026-02-22', date '2026-04-04', 'New Copy', 800, 0, 800
  union all select (select id from campaigns where ref='AE-2592'), 'RAN0097', 'Lee Capon', 'media', 'OOH', 'JCD', 'M4 Tower', date '2026-06-30', date '2026-06-30', 'New Copy', 400, 15, 400
