-- ADEX Randox import - part 2 of 6
...
select * from (
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2025-12-29', date '2026-01-11', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2025-12-29', date '2026-01-11', 'New Copy', 1979, 0, 1979
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2025-12-29', date '2026-01-11', 'New Copy', 406, 0, 406
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2025-12-29', date '2026-01-11', 'New Copy', 652, 0, 652
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2025-12-29', date '2026-01-11', 'New Copy', 4878, 0, 4878
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-02-09', date '2026-02-22', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-02-09', date '2026-02-22', 'New Copy', 2615, 0, 2615
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-03-09', date '2026-03-22', 'New Copy', 819, 0, 819
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-03-09', date '2026-03-22', 'New Copy', 1979, 0, 1979
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-03-09', date '2026-03-22', 'New Copy', 406, 0, 406
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-03-09', date '2026-03-22', 'New Copy', 652, 0, 652
  ...
  union all select (select id from campaigns where ref='AE-2578'), 'RAN0078', 'Karima Benzema', 'production', 'OOH', 'Global OOH', 'Production Charge', date '2026-03-09', date '2026-03-22', 'New Copy', 4878, 0, 4878
) v;
